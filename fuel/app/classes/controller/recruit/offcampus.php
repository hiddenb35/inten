...
class Controller_Recruit_Offcampus extends Controller_Loggedin
{
	public function action_add()
	{
		...
		$this->template->content = View::forge('recruit/off_campus_add');
	}

	public function action_edit()
	{
		$this->template->title = '学外説明会編集';
		$this->template->content = View::forge('recruit/off_campus_edit');
	}

	public function action_list()
	{
		$this->template->title = '学外説明会一覧';
		$this->template->content = View::forge('recruit/off_campus_list');
	}

	public function action_confirm()
	{
		$this->template->title = '学外説明会確認';
