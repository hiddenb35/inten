...
class Auth_Group_Teachergroup extends \Auth\Auth_Group_Driver
{
	...
	{
		static::$_valid_groups = array_keys(\Config::get('teacherauth.groups', array()));
	}

	protected $config = array(
		'drivers' => array('acl' => array('Teacheracl')),
	);
	...
	public function get_name($group = null)
	{
		...
		return \Config::get('teacherauth.groups.'.$group.'.name', null);
	}
	...
	public function get_roles($group = null)
	{
		...
		$groups = \Config::get('teacherauth.groups');
