...
class Auth_Group_Studentgroup extends \Auth\Auth_Group_Driver
{
	...
	{
		static::$_valid_groups = array_keys(\Config::get('studentauth.groups', array()));
	}

	protected $config = array(
		'drivers' => array('acl' => array('Studentacl')),
	);
	...
	public function get_name($group = null)
	{
		...
		return \Config::get('studentauth.groups.'.$group.'.name', null);
	}
	...
	public function get_roles($group = null)
	{
		...
		$groups = \Config::get('studentauth.groups');
