...
class Auth_Acl_Teacheracl extends \Auth\Auth_Acl_Driver
{
	protected static $_valid_roles = array();

	public static function _init()
	{
		static::$_valid_roles = array_keys(\Config::get('teacherauth.roles'));
	}
	...
	public function has_access($condition, Array $entity)
	{
		...
		{
			$roles = \Config::get('teacherauth.roles', array());
