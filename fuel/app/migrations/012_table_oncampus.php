...
class Table_oncampus
{
	public function up()
	{
		\DBUtil::create_table('oncampus', array(
			'id' => array('type' => 'int', 'auto_increment' => true, 'unsigned' => true, 'comment' => '学内説明会ID'),
			...
			'entry_start'  => array('type' => 'date', 'comment' => '申し込み期限(開始)'),
			'entry_end'    => array('type' => 'date', 'comment' => '申込期限(終了)'),
