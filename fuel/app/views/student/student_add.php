<!-- Main content -->
<section id="STUDENT_ADD" class="content">
	<div class="container">
		<div class="row">
			<div class="col-md-9 col-md-offset-1">
				<form action="" method="post" class="form-horizontal" role="form" id="student_add_form" enctype="multipart/form-data">
					<input type="hidden" name="id" value="">
					<div class="info-box" id="student_add_box">
