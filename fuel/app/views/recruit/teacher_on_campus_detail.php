<!-- Main content -->
<section id="TEACHER_ON_CAMPUS_DETAIL" class="content">
	<div class="container-fluid">
		<div class="row">
			<button type="button"
					class="btn btn-danger btn-lg company-button col-xs-offset-3 col-xs-6 hidden-xs"
			...
			<div class="col-sm-7 col-md-offset-1 col-md-6">
				<div class="box company-information">
					<div class="box-header inner-box-header clearfix">
						<span class="h4"><strong><?php echo $oncampus['company_name']; ?></strong></span>
					</div>
					<div class="box-body">
